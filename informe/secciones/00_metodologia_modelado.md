...
de la media y la variación. También se utilizaron las pruebas ADF y KPSS, junto
con las gráficas ACF y PACF, para decidir si era necesario diferenciar la serie
y para proponer valores razonables de `p`, `d`, `q`, `P`, `D` y `Q`. Estas
...
Para S0 se aplicó una transformación logarítmica porque todos los valores son
positivos. En S5 se utilizó `log1p`, ya que la serie contiene cinco meses en
